...
This is an n8n community node that integrates \[Voico.ai](https://voico.ai) AI voice agents into your n8n workflows. It enables you to schedule outbound AI calls, retrieve call details, and fetch full transcripts directly from your automations.
...
The node returns a `job\_id` which can be used to retrieve call details and transcripts.
